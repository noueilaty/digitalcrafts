...
// Sets default value to all menu options:
let viewOpt = 'all';

// if View 'All' option is selected:
function viewOption() {
  viewOpt = document.getElementById('viewMenu').value;
   console.log(viewOpt);
  viewItems(viewOpt);
}


function viewItems(opt) {
  // 1. Clear the 'dishes' div.
  // 2. Iterate through all the items in the dishes array.
  // 3. If the 'course' matches the opt parameter:
  // 4. Append the contents using liItem.
